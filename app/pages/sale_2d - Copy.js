          ...
          style={{
            ...
            <View style={{ flexDirection:'row', alignItems:'center', justifyContent:'center', marginTop:8 }}>
              <TouchableOpacity
                ...
                onPress={() => this.setState({ combineAmountType:'money' })}
              >
              ...
              <TouchableOpacity
                style={{ flexDirection:'row', alignItems:'center', marginHorizontal:10 }}
                onPress={() => this.setState({ combineAmountType:'25' })}
              >
              ...
              <TouchableOpacity
                style={{ flexDirection:'row', alignItems:'center', marginHorizontal:10 }}
                onPress={() => this.setState({ combineAmountType:'100' })}
              >
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            ...
            this.setState({
              ...
              combineAmountType: this.getCombineAmountTypeFromUnitPrice(this.state.unitPrice),
              pasteTxt: text,
            });
          }}>
          <Image
