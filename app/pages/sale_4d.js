...
APISlipDetail(TermDetailID, Num) {
  dal.APISlipDetail(this.props.navigation.state.params.endpoint, TermDetailID, Num, (err, resp) => {
                ...
                <View style={{
                  ...
                  <View style={{width:width*0.75,height:height*0.08,justifyContent:'center',alignItems:'center',marginHorizontal:width*0.05}}>
                    <Picker
                      ...
                      onValueChange={(itemValue, itemIndex) =>{
                        //this.getAfterBet(itemValue,this.state.termDetailsid)
                        let i=this.state.user.findIndex(x => x.UserID==itemValue);
                        this.setState({userid:itemValue,termDetails:[],discount:this.state.user[i].Discount3D,UseMoneyInOut:this.state.user[i].UseMoneyInOut})
                      }
                      }>
                      {this.renderUsers()}
                    </Picker>
                ...
                >
                  ...
                  ,alignItems:'center',marginHorizontal:width*0.05,flexDirection:'row'}}
                    ...
                    <TouchableOpacity onPress={()=>{
                      ...
                      }} style={{flex:1,marginHorizontal:5,paddingVertical:5,backgroundColor:'red',
                    ...
                    <TouchableOpacity onPress={()=>{
                      ...
                      }} style={{marginRight:5,flex:1,paddingVertical:5,backgroundColor:Color.Green,borderRadius:5,
                  ...
                  ,alignItems:'center',marginHorizontal:width*0.05,flexDirection:'row'}}
                    ...
                    }} style={{flex:1,marginHorizontal:5,paddingVertical:5,backgroundColor:Color.Green,borderRadius:5,
                      alignItems:'center',justifyContent:'center'}}>
    ...
    pressNum(n){
      if(var_selected=='num'){
        var_num=var_num.length<4?var_num+n:var_num+''
        this.numComponent.setNativeProps({text:var_num})
        if(var_num.length==4&&this.containsOnlyNumbers(var_num)&&(this.state.sameUnit||this.state.sameUnitR)){
          if(var_unit==''){
    ...
    Round4D(txtNum) {
        let IsFirst = true;
        let digit = [...txtNum]; //txtNum.trim().ToCharArray();
        ...
        UUIDGenerator.getRandomUUID().then((uuid) => {
              ...
              case 0:
                {
                  ...
                  // APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  // DetailEntity.Num = digit[0].toString() + digit[1].toString() + digit[2].toString() + digit[3].toString();
                  // this.SaleDetail_DataBind(DetailEntity, IsFirst);
                  // tempNumList.Add(DetailEntity);
                  // EntityCollection.Add(DetailEntity);
                  // IsFirst = false;
                }
                break;
              case 1:
                {
                  console.log('IsContain ',tempNumList)
                  console.log('case ',1)
                  //APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  let Num =
                    digit[0].toString() +
                  ...
                  try {
                    const IsContain = tempNumList.find(
                      (item) =>
                        item.num.toLowerCase() == Num
                    );
                    console.log('IsContain ',IsContain)
                    //var IsContain = tempNumList.Where(item => item.Num.Trim().ToLower() == DetailEntity.Num.Trim().ToLower()).SingleOrDefault().Num;
                     if (!IsContain) {
                        tempNumList.push({
                          num: Num,
                          unit: var_unit,
                        ...
                        console.log('case 1',tempNumList)
                      // tempNumList.Add(DetailEntity);
                      // EntityCollection.Add(DetailEntity);
                      IsFirst = false;
                    }
              ...
              case 2:
                {
                  ...
                  let Num =
                    ...
                    digit[3].toString();
                  // APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  // DetailEntity.Num = digit[0].toString() + digit[2].toString() + digit[1].toString() + digit[3].toString();
                  // this.SaleDetail_DataBind(DetailEntity, IsFirst);
      
                  try {
                    const IsContain = tempNumList.find(
                      (item) =>
                        item.num.trim().toLowerCase() === Num.trim().toLowerCase()
                    );
                    //var IsContain = tempNumList.Where(item => item.Num.Trim().ToLower() == DetailEntity.Num.Trim().ToLower()).SingleOrDefault().Num;
                     if (!IsContain) {
                        tempNumList.push({
              ...
              case 3:
                {
                  let Num =
                    ...
                    digit[1].toString();
                  // APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  // DetailEntity.Num = digit[0].toString() + digit[2].toString() + digit[3].toString() + digit[1].toString();
                  // this.SaleDetail_DataBind(DetailEntity, IsFirst);
                  try {
                    const IsContain = tempNumList.find(
                      (item) =>
                    ...
                    //var IsContain = tempNumList.Where(item => item.Num.Trim().ToLower() == DetailEntity.Num.Trim().ToLower()).SingleOrDefault().Num;
                     if (!IsContain) {
                      //if (string.IsNullOrEmpty(IsContain))
                        tempNumList.push({
                          num: Num,
                          unit: var_unit,
                          summary: txtNum + "R",
              ...
              case 4:
                {
                  let Num =
                    ...
                    digit[2].toString();
                  // APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  // DetailEntity.Num = digit[0].toString() + digit[3].toString() + digit[1].toString() + digit[2].toString();
                  // this.SaleDetail_DataBind(DetailEntity, IsFirst);
                  try {
                    const IsContain = tempNumList.find(
                      (item) =>
              ...
              case 5:
                {
                  let Num =
                    ...
                    digit[1].toString();
                  // APISaleDetailOwner DetailEntity = new APISaleDetailOwner();
                  // DetailEntity.Num = digit[0].toString() + digit[3].toString() + digit[2].toString() + digit[1].toString();
                  // this.SaleDetail_DataBind(DetailEntity, IsFirst);
                  try {
                    const IsContain = tempNumList.find(
                      (item) =>
              ...
              case 22:
                {
                  ...
                  try {
                    ...
                    console.log("tempNumList ",tempNumList)
                    console.log("Num ",Num)
                    console.log("IsContain ",IsContain)
                     if (!IsContain) {
                      tempNumList.push({
          ...
          this.setState(
            {
              dataProvider: dataProvider.cloneWithRows(
                tempNumList.concat(__data),
              ),
              data: this.state.data.concat(tempNumList),
              dataforSwap: tempNumList.concat(__data),
              },()=>{
        ...
        //                 this.setState(
        //                   {
        //                     dataProvider: dataProvider.cloneWithRows(tempNumList.concat(__data)),
        //                     data: this.state.data.concat(tempNumList),
        //                     dataforSwap: tempNumList.concat(__data),
        //                   },
        //                   () => {
    ...
    pressOk(){
      if(var_selected=='num'&&!this.state.sameUnit&&!this.state.sameUnitR){
        ...
        this.refs.err_toast.show('ထိုးလိုသောယူနစ်ထည့်ရမည်။',1000);
      }else if(var_chosen==''&&var_num.length!=4){
        this.refs.err_toast.show('ဂဏန်းသုံးလုံးဖြစ်ရမည် ',1000);
      }else{
        if(var_chosen=='break'){
          var t=[]
    ...
    return (
        <View style={styles.container}>
          ...
          <Animated.View style={{position:'absolute',bottom:0,left:0,right:0,
            ...
            <View style={{width:width,height:height*0.06,flexDirection:'row'}}>
              ...
              <TouchableOpacity style={{justifyContent:'center',alignItems:'flex-end'}}
                ...
                <Image source={close} style={{width:height*0.04,height:height*0.04,tintColor:'red',marginRight:10}}/>
              </TouchableOpacity>
            </View>
            ...
            <View style={{width:width,height:height*0.09,flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
              ...
              <TouchableOpacity style={{width:(width*0.5)-7.5,height:height*0.07,justifyContent:'center',alignItems:'center',marginHorizontal:5,backgroundColor:Color.lightGreen,borderRadius:5}}
                onPress={this.pressOk.bind(this)}>
                <Text style={estyles.NumText}>OK</Text>
              </TouchableOpacity>
            </View> */}
